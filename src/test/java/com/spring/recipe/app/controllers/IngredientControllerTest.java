package com.spring.recipe.app.controllers;
...
import com.spring.recipe.app.services.IngredientService;
import com.spring.recipe.app.services.RecipeService;
import com.spring.recipe.app.services.UnitOfMeasureService;
...
public class IngredientControllerTest {
  ...
  public void testSaveOrUpdate() throws Exception {
    ...
    // then
    mockMvc
        .perform(post("/recipe/2/ingredient").contentType(MediaType.APPLICATION_FORM_URLENCODED)
